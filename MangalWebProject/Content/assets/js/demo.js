   ...
   var runDemoCache = function() {
      ...
      $(window).load(function() {
         ...
         var scripts = {
            ...
            image1: '~/Content/assets/img/stock/1.jpg',
            image2: '~/Content/assets/img/stock/2.jpg',
            image3: '~/Content/assets/img/stock/3.jpg',
            image4: '~/Content/assets/img/stock/4.jpg',
            image5: '~/Content/assets/img/stock/5.jpg',

            bg1: '~/Content/assets/img/patterns/backgrounds/1.jpg',

            // HIGH PRIORITY - Admin Tools Assets
            adminform:  '~/Content/assets/admin-tools/admin-forms/css/admin-forms.css',
            adminpanel: '~/Content/assets/admin-tools/admin-plugins/admin-panels/adminpanels.css',
            adminmodal: '~/Content/assets/admin-tools/admin-plugins/admin-modal/adminmodal.css',
            admindock:  '~/Content/assets/admin-tools/admin-plugins/admin-dock/dockmodal.css',
